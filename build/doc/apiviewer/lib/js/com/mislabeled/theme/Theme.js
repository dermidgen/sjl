 ...
 * @constructor
 */
com.mislabeled.theme.Theme = Class.create();
com.mislabeled.theme.Theme.inherits("com.mislabeled.EventDispatcher");
com.mislabeled.theme.Theme.prototype.initialize = function()
{
	/**
	 * Theme name
	 * @type string
	...
	this.LoadThemeDefs = function()
	{
		...
		var xhr = new com.mislabeled.io.Http();
		var e = {
...
com.mislabeled.theme.Theme.prototype.GetProperty = function(propertyName)
{
